...
setFrontendImage(URL.createObjectURL(file))
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px] '>
      ...
      <div className='w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-gray-500 rounded-2xl'></div>
       <div className='w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-blue-500 rounded-2xl'></div>
        <div className='w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-green-500 rounded-2xl'></div>
         <div className='w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-red-500 rounded-2xl'></div>
          <div className='w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-yellow-500 rounded-2xl'></div>
           <div className='w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-purple-500 rounded-2xl'></div>
            <div className='w-[70px] h-[140px] lg:w-[150px] lg:h-[250px] bg-pink-500 rounded-2xl'></div>
